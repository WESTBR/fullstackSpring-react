package com.dtn.demo.app.web;

import com.dtn.demo.app.domain.ProjectTask;
import com.dtn.demo.app.service.ProjectTaskService;
...
public class ProjectTaskController {
   ...
   @DeleteMapping("/{pt_id}")
    public ResponseEntity<?> deleteProjectTask(@PathVariable Long pt_id){
        ...
        return new ResponseEntity<String>("project Tast deleted",HttpStatus.OK);
   }
}
